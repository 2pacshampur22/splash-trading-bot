import {
  require_jsx_runtime
} from "./chunk-3IRTAGWP.js";
import {
  __commonJS,
  __export,
  __toESM,
  require_react
} from "./chunk-7UVZ4JKC.js";
...
function buildProjectionTree(elements, existingContext, options) {
  ...
  const nodes = (_a = existingContext == null ? void 0 : existingContext.nodes) != null ? _a : /* @__PURE__ */ new Map();
  const visualElements = (_b = existingContext == null ? void 0 : existingContext.visualElements) != null ? _b : /* @__PURE__ */ new Map();
  const group = (_c = existingContext == null ? void 0 : existingContext.group) != null ? _c : nodeGroup();
  ...
  for (const element of sorted) {
    ...
    const nodeOptions = {
      layoutId: layoutId != null ? layoutId : void 0,
